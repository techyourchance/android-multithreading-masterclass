...
public class SolutionExercise8Fragment extends BaseFragment implements ComputeFactorialUseCase.Listener {

    public static Fragment newInstance() {
        return new SolutionExercise8Fragment();
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mComputeFactorialUseCase = new ComputeFactorialUseCase(
                new UiThreadPoster(), // you need to get this dependency from composition root
                new BackgroundThreadPoster() // you need to get this dependency from composition root
        );
    }
