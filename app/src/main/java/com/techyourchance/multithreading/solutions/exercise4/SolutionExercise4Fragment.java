package com.techyourchance.multithreading.solutions.exercise4;
...
public class SolutionExercise4Fragment extends BaseFragment {
    ...
    private void processComputationResults() {
        ...
        mUiHandler.post(new Runnable() {
            @Override
            public void run() {
                if (!SolutionExercise4Fragment.this.isStateSaved()) {
